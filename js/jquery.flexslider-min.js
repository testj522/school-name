    ...
    $.flexslider = function(t, a) {
        ...
        $.data(t, "flexslider", n), f = {
            init: function() {
                ...
                }), n.container.empty().append(n.slides)), n.doMath(), n.setup("init"), n.vars.directionNav && f.directionNav.setup(), n.vars.controlNav && f.controlNav.setup(), n.vars.keyboard && (1 === $(n.containerSelector).length || n.vars.multipleKeyboard) && $(document).bind("keyup", function(e) {
                    /*var t = e.keyCode;
            ...
            directionNav: {
                setup: function() {
                    var e = $('<ul class="' + i + 'direction-nav"><li class="' + i + 'nav-prev"><button type="button" class="' + i + 'prev">' + n.vars.prevText + '</button></li><li class="' + i + 'nav-next"><button type="button" class="' + i + 'next">' + n.vars.nextText + "</button></li></ul>");
                    n.customDirectionNav ? n.directionNav = n.customDirectionNav : n.controlsContainer ? ($(n.controlsContainer).append(e), n.directionNav = $("." + i + "direction-nav li a", n.controlsContainer)) : (n.append(e), n.directionNav = $("." + i + "direction-nav li button", n)), f.directionNav.update(), n.directionNav.bind(o, function(e) {
                        e.preventDefault();
			...
			controlNav: {
                ...
                setupPaging: function() {
                    ...
                    if (n.controlNavScaffold = $('<ol class="' + i + "control-nav " + i + e + '"></ol>'), n.pagingCount > 1)
                        for (var r = 0; r < n.pagingCount; r++) {
                            ...
                            if (a = "thumbnails" === n.vars.controlNav ? '<img src="' + s.attr("data-thumb") + '"' + c + "/>" : '<button type="button" title="Slide ' + t + '"><span>' + t + "</span></button>", "thumbnails" === n.vars.controlNav && !0 === n.vars.thumbCaptions) {
                                var d = s.attr("data-thumbcaption");
                                "" !== d && void 0 !== d && (a += '<span class="' + i + 'caption">' + d + "</span>")
                            }
                            n.controlNavScaffold.append("<li>" + a + "</li>"), t++
                        }
                    n.controlsContainer ? $(n.controlsContainer).append(n.controlNavScaffold) : n.append(n.controlNavScaffold), f.controlNav.set(), f.controlNav.active(), n.controlNavScaffold.delegate("button, img", o, function(e) {
                ...
                set: function() {
                    var e = "thumbnails" === n.vars.controlNav ? "img" : "button";
